...
const OneFilePreview: React.FC<FilePreviewProps> = ({ file, onDelete }) => {
      ...
      <div className="p-2 border rounded flex w-full justify-between">
        ...
        <div className="flex items-center">
          <Button
            ...
            data-tooltip-id={`my-tooltip_file`}
          ...
          <Tooltip id={`my-tooltip_file`} place="left" />
        </div>
      </div>
    );
  }
